  ...
  return (
    <IonContent fullscreen className="ion-padding">
      <div className="container">
        ...
        <p>
          Hello <strong>{registeredUser}</strong> you created an account, now
          click <b>continue</b> if you want to be freelancer, click <b>skip</b>{" "}
          if you just want to be a client.
        </p>
        {/* </IonTitle> */}
        <IonButton
          className="ion-margin"
          routerLink="./freelancerDetails"
          expand="block"
        >
          Continue
        </IonButton>
        <IonButton
          className="ion-margin"
          routerLink="./enterClientLocation"
          fill="outline"
          expand="block"
        >
          Skip
