  ...
  return (
    <IonContent fullscreen className="ion-padding">
      <div>
            ...
            showCategoryContent && (
              ...
              <IonContent fullscreen className="ion-padding">
                <div className="container">
                  ...
                  <p>
                    We will show you relevant gigs associated with your skill
                    set.
                  </p>
                  ...
                  <IonGrid>
                    <IonRow className="ion-padding-start ion-padding-end">
                      {category
                        ...
                        .map((single) => (
                          <IonCol
                            onClick={() => handleChooseCategory(single.name)}
                          >
                            <div className="posts">
                              {!loadingThing && (
                                <div className="container">
                              ...
                              <img
                                className="ion-padding animate__animated animate__fadeIn animate__delay-0.1s"
                                src={single.image}
                                height="90"
                                width="90"
                                loading="lazy"
            ...
            showServicesContent && (
              ...
              <IonContent fullscreen className="ion-padding">
                <div className="container">
                  ...
                  <p>
                    enter all the services and products that you provide and
                  ...
                  <IonButton fill="outline" onClick={closeServicersModal}>
                    Close
                  </IonButton>
                </div>
              </IonContent>
        ...
        <p className="name">
          Here tell your potential customers about yourself on what you are
          providing
        </p>
        <IonList ref={ref} className="ion-padding-bottom">
          ...
          <IonItem className="ion-padding-top">
            <IonInput
              onClick={servicersModal}
              value={servicesData.toString()}
              placeholder="Your services: Servicers that you provide"
            ></IonInput>
          </IonItem>
          <IonItem className="ion-padding-top">
            <IonInput
          ...
          {status === "OK" && (
            <IonList className="ion-padding">{renderSuggestions()}</IonList>
          )}
        </IonList>
        <IonButton
          className="ion-margin"
